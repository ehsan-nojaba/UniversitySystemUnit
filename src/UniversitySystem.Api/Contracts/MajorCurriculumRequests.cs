...
/// <summary>ساخت درس جدید و اتصال همزمان به رشته بدون تغییر چارت سایر رشته‌ها.</summary>
public sealed record CreateMajorCourseRequest(string Code, string Title, int Credits, int RecommendedTerm, bool IsRequired);
