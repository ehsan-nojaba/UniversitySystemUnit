...
{
    public Task CheckConflictsAsync(long courseOfferingId, IReadOnlyCollection<CourseOfferingScheduleSlotDto> slots, CancellationToken cancellationToken = default) => CheckAsync(courseOfferingId, slots, null, cancellationToken);
    public Task CheckProfessorAssignmentAsync(long courseOfferingId, long professorId, IReadOnlyCollection<CourseOfferingScheduleSlotDto> slots, CancellationToken cancellationToken = default) => CheckAsync(courseOfferingId, slots, professorId, cancellationToken);
